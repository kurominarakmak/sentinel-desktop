...
| Planned B2 textual extraction | Caller-controlled paths or ambiguous worktree selection, stale B1 authority, same-numstat/different-content or newline-state races, ambiguous unified-diff grammar, filter/helper or built-in attribute drift, aggregate output/memory/command exhaustion, lifecycle revocation, reassociation, or partial-output leakage | The approved B2 contract requires exact typed ProjectId/WorktreeId association, fresh A/B/C and C1/C2/C3 validation, independent E1/E2/E3 lossless structured equality, B2-B0 grammar approval, conservative attribute deferral, aggregate bounded accounting, refreshed rows, and final Git validation | Contract requirement only: no B2 production extraction, parser, or public bridge exists until later implementation and review |
